...
const FloatingCartButton: React.FC<FloatingCartButtonProps> = ({ itemCount, onCartClick }) => {
  ...
  return (
    <button
      onClick={onCartClick}
          className="fixed bottom-6 right-6 bg-orange-600 text-white p-4 rounded-full shadow-lg hover:bg-orange-700 transition-all duration-200 transform hover:scale-110 z-40 md:hidden"
    >
